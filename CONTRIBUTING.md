# Start contributing to [`@proj-airi/iconify-meteocons`](https://github.com/proj-airi/iconify-meteocons)
...
Click on the **Fork** button on the top right corner of the [`proj-airi/iconify-meteocons`](https://github.com/proj-airi/iconify-meteocons) page.
...
>
> ```shell
> git remote add upstream https://github.com/proj-airi/iconify-meteocons.git
> ```

## Creating Pull Request

Navigate to [`proj-airi/iconify-meteocons`](https://github.com/proj-airi/iconify-meteocons) page, click on the **Pull requests** tab, and click on the **New pull request** button, click on the **Compare across forks** link, and select your fork repository.
